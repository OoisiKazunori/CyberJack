...
#pragma region インスタンシング描画
	{
		...
		lineData.range[1] = GRAPHICS_RANGE_TYPE_SRV;
...
#pragma endregion
...

	{
		...
		uaAndTexData.range[1] = GRAPHICS_RANGE_TYPE_CBV;
...

	{
		...
		lData.range[0] = GRAPHICS_RANGE_TYPE_CBV;
...

	{
		...
		lData.range[4] = GRAPHICS_RANGE_TYPE_CBV;
...

	{
		...
		GraphicsRootSignature::Instance()->CreateRootSignature(ROOTSIGNATURE_DATA_UAV_UAV_UAV_CBV, lData, 3);
	}
}
