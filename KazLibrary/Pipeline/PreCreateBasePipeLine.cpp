...
#pragma region シェーダーのコンパイルと登録
	...
	//コンピュートシェーダーのコンパイル
	pipelineMgr->RegisterComputeShaderWithData(KazFilePathName::ComputeShaderPath + "TestComputeShader.hlsl", "CSmain", "cs_6_0", SHADER_COMPUTE_TEST);
	...
	pipelineMgr->RegisterVertexShaderWithData(KazFilePathName::VertexShaderPath + "GpuParticleVertexShader.hlsl", "VSmain", "vs_5_0", SHADER_VERTEX_GPUPARTICLE);
