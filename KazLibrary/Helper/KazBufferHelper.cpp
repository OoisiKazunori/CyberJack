...
D3D12_UNORDERED_ACCESS_VIEW_DESC KazBufferHelper::SetUnorderedAccessView(BUFFER_SIZE BUFFER_SIZE, UINT NUM_ELEMENTS)
{
	...
	uavDesc.Buffer.StructureByteStride = BUFFER_SIZE;
