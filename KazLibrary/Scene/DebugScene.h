...
struct OutPutData
{
	...
	DirectX::DirectX::XMFLOAT4 color;
};
...
struct CommonData
{
	...
	DirectX::UINT increSize;
	DirectX::UINT64 gpuAddress;
	DirectX::XMUINT2 pad;
};
...
private:
	...
	static const int TRIANGLE_ARRAY_NUM = 2;
	...
	DirectX::UINT AlignForUavCounter(DirectX::UINT bufferSize)
	{
