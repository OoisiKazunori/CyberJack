...
#pragma region RezStage
	...
	//responeData[ENEMY_TYPE_MISILE][respoineIndex].flame = time * 15;
	...
	responeData[ENEMY_TYPE_MOTHER][respoineIndex].flame = time * 1;
	responeData[ENEMY_TYPE_MOTHER][respoineIndex].generateData.initPos = { 0.0f,50.0f,300.0f };
	++respoineIndex;


	responeData[ENEMY_TYPE_BATTLESHIP][respoineIndex].layerLevel = layerLevel;
	responeData[ENEMY_TYPE_BATTLESHIP][respoineIndex].flame = time * 60;
